...
namespace NGTech {
	...
	I_Shader  *GLSystem::ShaderCreate(const String &path, const String &defines){ return GLShader::create(path, defines); }
	I_FBOManager*GLSystem::CreateFBO(int x, int y){ return GLFBO::create(x, y); }
