...
namespace MyGUI
{
	...
	void Button::initialiseOverride()
	{
		...
		///@wskin_child{Button, ImageBox, Image} ��������, � ������ �������� ���������� ��������� ������.
