...
#define MAXVER_INTERNALNAME "MetaSLProxyMaterial\0"//should  be overridden on a per-dll level
#define MAXVER_ORIGINALFILENAME "MetaSLProxy.dlt\0"//should  be overridden on a per-dll level
#define MAXVER_FILEDESCRIPTION "Map to Material Conversion (plugin)\0"//should  be overridden on a per-dll level
#define MAXVER_COMMENTS "\0"//should  be overridden on a per-dll level
