...
IOResult R25Sampler::Load(ILoad *iload)
{
	...
	if (version < PB_CURRENT_VERSION ) {
		iload->RegisterPostLoadCallback(new ParamBlockPLCBEx(oldVersions,NUM_OLDVERSIONS, &curVersion, this,0));
...
IOResult AdaptiveHaltonSampler::Load(ILoad *iload)
{
	...
	if (version < APB_CURRENT_VERSION ) {
		iload->RegisterPostLoadCallback(new ParamBlockPLCBEx(oldAVersions,NUM_OLDAVERSIONS, &curAVersion, this,0));
