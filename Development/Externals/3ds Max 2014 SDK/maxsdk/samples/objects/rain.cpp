...
public:
	ParamBlockPLCBEx* cb;
	ParticlePostLoadCallback(ParamBlockPLCBEx* c) {cb=c;}
	...
	if (ClassID()==Class_ID(RAIN_CLASS_ID,0)) {
		iload->RegisterPostLoadCallback(
			new ParticlePostLoadCallback(
				new ParamBlockPLCBEx(versions,NUM_OLDVERSIONS,&curVersionRain,this,0)));
	} else {
		iload->RegisterPostLoadCallback(
			new ParticlePostLoadCallback(
				new ParamBlockPLCBEx(versions,NUM_OLDVERSIONS,&curVersionSnow,this,0)));
		}
	return IO_OK;
	}
