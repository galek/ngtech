...
public:
	ParamBlockPLCBEx *cb;
	CommonPostLoadCallback(ParamBlockPLCBEx *c) {cb=c;}
   ...
   if (ClassID()==BLIZZARD_CLASS_ID) {
      iload->RegisterPostLoadCallback(
         new CommonPostLoadCallback(
            new ParamBlockPLCBEx(Bversions,NUM_OLDVERSIONS,&curVersionBL,this,0)));
   } else {
      iload->RegisterPostLoadCallback(
         new CommonPostLoadCallback(
            new ParamBlockPLCBEx(spversions,NUM_OLDVERSIONS,&curVersionSp,this,0)));
      }
   ULONG nb;
   IOResult res = IO_OK;
   int cnmtl=0,nCount;
