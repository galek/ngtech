...
public:
	BOOL tex;
	ParamBlockPLCBEx *cb;
	TriPatchPostLoadCallback(ParamBlockPLCBEx *c) {cb=c; tex=FALSE;}
...
IOResult  TriPatchObject::Load(ILoad *iload) {
	TriPatchPostLoadCallback *plcb = new TriPatchPostLoadCallback(new ParamBlockPLCBEx(versions,NUM_OLDVERSIONS,&curVersion,this,0));
