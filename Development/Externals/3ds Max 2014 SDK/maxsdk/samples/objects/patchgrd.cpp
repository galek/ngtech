...
public:
	BOOL tex;
	ParamBlockPLCBEx *cb;
	QuadPatchPostLoadCallback(ParamBlockPLCBEx *c) {cb=c; tex=FALSE;}
...
IOResult  QuadPatchObject::Load(ILoad *iload) {
	QuadPatchPostLoadCallback *plcb = new QuadPatchPostLoadCallback(new ParamBlockPLCBEx(versions,NUM_OLDVERSIONS,&curVersion,this,0));
