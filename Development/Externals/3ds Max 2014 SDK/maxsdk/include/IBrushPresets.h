...
#pragma warning( disable : 4481 )
		...
		virtual int			ReadConfig(MCHAR *cfg) sealed { return ReadConfig(const_cast<const MCHAR*>(cfg)); }
#pragma warning( pop )
...
#pragma warning( disable : 4481 )
		//! \deprecated Deprecated method in terms of implementation as of 3ds Max 2013 - re-implement with const MCHAR* method signature
		virtual int			WriteConfig(MCHAR *cfg) sealed { return WriteConfig(const_cast<const MCHAR*>(cfg)); }
#pragma warning( pop )
};
