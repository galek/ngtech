...
\The output parameters are the shortcuts.Return true if the shortcuts can be get,otherwise,it is false.
*/
...
/*! Helper function to get the value of operation parameter such as zoom in direction of customized zoom mode.
\Return true if value can be get,otherwise,it is false.
*/
