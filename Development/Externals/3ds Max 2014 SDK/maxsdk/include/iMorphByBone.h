...
#pragma warning( disable : 4481 )
		...
		virtual void	fnSelectBone(INode *node,MCHAR* morphName) sealed { fnSelectBone(node, const_cast<const MCHAR*>(morphName)); }
#pragma warning( pop )
...
#pragma warning( disable : 4481 )
		//! \deprecated Deprecated method in terms of implementation as of 3ds Max 2013 - re-implement with const MCHAR* method signature
		virtual void	fnRemoveMorph(INode *node, MCHAR *name) sealed { fnRemoveMorph(node, const_cast<const MCHAR*>(name)); }
#pragma warning( pop )
...
#pragma warning( disable : 4481 )
		//! \deprecated Deprecated method in terms of implementation as of 3ds Max 2013 - re-implement with const MCHAR* method signature
		virtual void	fnResetOrientation(INode *node, MCHAR *name) sealed { fnResetOrientation(node, const_cast<const MCHAR*>(name)); }
#pragma warning( pop )
...
#pragma warning( disable : 4481 )
		//! \deprecated Deprecated method in terms of implementation as of 3ds Max 2013 - re-implement with const MCHAR* method signature
		virtual void	fnReloadTarget(INode *node, MCHAR *name) sealed { fnReloadTarget(node, const_cast<const MCHAR*>(name)); }
#pragma warning( pop )
...
#pragma warning( disable : 4481 )
		//! \deprecated Deprecated method in terms of implementation as of 3ds Max 2013 - re-implement with const MCHAR* method signature
		virtual void	fnEditFalloffGraph(INode *node, MCHAR *name) sealed { fnEditFalloffGraph(node, const_cast<const MCHAR*>(name)); }
#pragma warning( pop )
...
#pragma warning( disable : 4481 )
		//! \deprecated Deprecated method in terms of implementation as of 3ds Max 2013 - re-implement with const MCHAR* method signature
		virtual void	fnSetExternalNode(INode *node, MCHAR *name,INode *exnode) sealed { fnSetExternalNode(node, const_cast<const MCHAR*>(name), exnode); }
#pragma warning( pop )
...
#pragma warning( disable : 4481 )
		//! \deprecated Deprecated method in terms of implementation as of 3ds Max 2013 - re-implement with const MCHAR* method signature
		virtual void	fnBoneSetMorphName(INode *node, int morphIndex, MCHAR* name) sealed { fnBoneSetMorphName(node, morphIndex, const_cast<const MCHAR*>(name)); }
#pragma warning( pop )
		...
		/// float	 fnGetWeight(INode *node, const MCHAR*name)
...
#pragma warning( disable : 4481 )
		//! \deprecated Deprecated method in terms of implementation as of 3ds Max 2013 - re-implement with const MCHAR* method signature
		virtual float	 fnGetWeight(INode *node, MCHAR*name) sealed { return fnGetWeight(node, const_cast<const MCHAR*>(name)); }
#pragma warning( pop )
