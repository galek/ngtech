...
public:
	...
	*/
	...
	\param true to indicate this is a instance stream
	*/
...
public:
	...
	*/
	...
	\param the max material ID of a multi-sub material. 
	*/
	DataBridgeAPI void SetMaxMaterialID(MtlID value);

	/** Get the max material ID of a multi-sub material.
	\param the max material ID of a multi-sub material. Default value is 0.
	*/
