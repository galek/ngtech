...
namespace MaxSDK { namespace Graphics {
	/**	The pipeline context contains the complete state of a single item
		being drawn all system supplied variables are contained here,
		as is the current virtual device 
	*/
