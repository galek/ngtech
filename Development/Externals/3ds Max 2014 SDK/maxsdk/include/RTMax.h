...
#pragma warning( disable : 4481 )
	...
	virtual void SetFloatParam(D3DXHANDLE handle, MCHAR * paramName, MCHAR * uiName, float val,float min, float max, float step,MaxSemantics semantic ) sealed { 
		SetFloatParam(handle, const_cast<const MCHAR*>(paramName), const_cast<const MCHAR*>(uiName), val, min, max, step, semantic ); }
#pragma warning( pop )
...
#pragma warning( disable : 4481 )
	//! \deprecated Deprecated method in terms of implementation as of 3ds Max 2013 - re-implement with const MCHAR* method signature
	virtual void SetIntParam(D3DXHANDLE handle, MCHAR * paramName, MCHAR * uiName,int val,int min, int max, int step,MaxSemantics semantic ) sealed { 
		SetIntParam(handle, const_cast<const MCHAR*>(paramName), const_cast<const MCHAR*>(uiName), val, min, max, step, semantic ); }
#pragma warning( pop )
...
#pragma warning( disable : 4481 )
	//! \deprecated Deprecated method in terms of implementation as of 3ds Max 2013 - re-implement with const MCHAR* method signature
	virtual void SetColorParam(D3DXHANDLE handle, MCHAR * paramName, MCHAR * uiName,D3DXVECTOR4 color,MaxSemantics semantic) sealed { 
		SetColorParam(handle, const_cast<const MCHAR*>(paramName), const_cast<const MCHAR*>(uiName), color, semantic ); }
#pragma warning( pop )
...
#pragma warning( disable : 4481 )
	//! \deprecated Deprecated method in terms of implementation as of 3ds Max 2013 - re-implement with const MCHAR* method signature
	virtual void SetPoint4Param(D3DXHANDLE handle, MCHAR * paramName, MCHAR * uiName,D3DXVECTOR4 val,float min, float max, float step,MaxSemantics semantic) sealed { 
		SetPoint4Param(handle, const_cast<const MCHAR*>(paramName), const_cast<const MCHAR*>(uiName), val, min, max, step, semantic ); }
#pragma warning( pop )
...
#pragma warning( disable : 4481 )
	//! \deprecated Deprecated method in terms of implementation as of 3ds Max 2013 - re-implement with const MCHAR* method signature
	virtual void SetBooleanParam(D3DXHANDLE handle, MCHAR * paramName, MCHAR * uiName,BOOL val,MaxSemantics semantic) sealed { 
		SetBooleanParam(handle, const_cast<const MCHAR*>(paramName), const_cast<const MCHAR*>(uiName), val, semantic ); }
#pragma warning( pop )
...
#pragma warning( disable : 4481 )
	//! \deprecated Deprecated method in terms of implementation as of 3ds Max 2013 - re-implement with const MCHAR* method signature
	virtual void SetTextureParam(D3DXHANDLE handle, MCHAR * paramName, MCHAR * uiName, MCHAR * filename, MaxSemantics semantic, bool mappingEnabled, int mappingChannel) sealed { 
		SetTextureParam(handle, const_cast<const MCHAR*>(paramName), const_cast<const MCHAR*>(uiName), const_cast<const MCHAR*>(filename), semantic, mappingEnabled, mappingChannel ); }
#pragma warning( pop )
...
#pragma warning( disable : 4481 )
	//! \deprecated Deprecated method in terms of implementation as of 3ds Max 2013 - re-implement with const MCHAR* method signature
	virtual void SetLightParam(D3DXHANDLE handle, MCHAR * paramName, MCHAR * uiName,bool target,MaxSemantics semantic) sealed { 
		SetLightParam(handle, const_cast<const MCHAR*>(paramName), const_cast<const MCHAR*>(uiName), target, semantic ); }
#pragma warning( pop )
...
#pragma warning( disable : 4481 )
	//! \deprecated Deprecated method in terms of implementation as of 3ds Max 2013 - re-implement with const MCHAR* method signature
	virtual void SetTechnique(D3DXHANDLE handle, MCHAR * techniqueName, bool bDefault) sealed { 
		SetTechnique(handle, const_cast<const MCHAR*>(techniqueName), bDefault); }
#pragma warning( pop )
...
#pragma warning( disable : 4481 )
	//! \deprecated Deprecated method in terms of implementation as of 3ds Max 2013 - re-implement with const MCHAR* method signature
	virtual bool LoadTexture(LPVOID pDevice, MCHAR * paramName, MCHAR * filename, bool forceReload, PBBitmap *pBitmap) sealed { 
		return LoadTexture(pDevice, const_cast<const MCHAR*>(paramName), const_cast<const MCHAR*>(filename), forceReload, pBitmap); }
#pragma warning( pop )
...
#pragma warning( disable : 4481 )
	//! \deprecated Deprecated method in terms of implementation as of 3ds Max 2013 - re-implement with const MCHAR* method signature
	virtual bool SaveEffectFile(MCHAR * fileName) sealed { return SaveEffectFile(const_cast<const MCHAR*>(fileName)); }
#pragma warning( pop )
...
#pragma warning( disable : 4481 )
	//! \deprecated Deprecated method in terms of implementation as of 3ds Max 2013 - re-implement with const MCHAR* method signature
	virtual void SetD3DMatrix(MCHAR * paramName) sealed { SetD3DMatrix(const_cast<const MCHAR*>(paramName)); }
#pragma warning( pop )
...
#pragma warning( disable : 4481 )
	//! \deprecated Deprecated method in terms of implementation as of 3ds Max 2013 - re-implement with const MCHAR* method signature
	virtual D3DXMATRIX GetD3DMatrix(MCHAR * paramName, TransformType matType) sealed { return GetD3DMatrix(const_cast<const MCHAR*>(paramName), matType); }
#pragma warning( pop )
...
#pragma warning( disable : 4481 )
	//! \deprecated Deprecated method in terms of implementation as of 3ds Max 2013 - re-implement with const MCHAR* method signature
	virtual LPDIRECT3DBASETEXTURE9 GetSceneRenderTarget(bool env, MCHAR * paramName) sealed { 
		return GetSceneRenderTarget(env, const_cast<const MCHAR*>(paramName)); }
#pragma warning( pop )
...
#pragma warning( disable : 4481 )
	//! \deprecated Deprecated method in terms of implementation as of 3ds Max 2013 - re-implement with const MCHAR* method signature
	virtual void SetSceneRenderTarget(LPDIRECT3DBASETEXTURE9 texture, MCHAR * paramName) sealed { 
		SetSceneRenderTarget(texture, const_cast<const MCHAR*>(paramName)); }
#pragma warning( pop )
...
#pragma warning( disable : 4481 )
	//! \deprecated Deprecated method in terms of implementation as of 3ds Max 2013 - re-implement with const MCHAR* method signature
	virtual void EnableDebugMode(bool onOff, MCHAR * outputPath, MCHAR * namePrefix) sealed { 
		EnableDebugMode(onOff, const_cast<const MCHAR*>(outputPath), const_cast<const MCHAR*>(namePrefix)); }
#pragma warning( pop )
