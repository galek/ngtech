...
#pragma warning( disable : 4481 )
	//! \deprecated Deprecated method in terms of implementation as of 3ds Max 2013. Implement SaveToFile( const MCHAR * fileName, FileIOType context )
	virtual int SaveToFile( MCHAR * fileName, FileIOType context ) MAX_SEALED { 
...
#pragma warning( push )
#pragma warning( disable : 4481 )
	//! \deprecated Deprecated method in terms of implementation as of 3ds Max 2013. Implement LoadFromFile( const MCHAR * fileName, FileIOType context )
	virtual int LoadFromFile( MCHAR * fileName, FileIOType context ) MAX_SEALED { 
