...
#pragma warning( disable : 4481 )
		...
		GUPExport virtual	bool			ExecuteStringScript	( MCHAR *string ) sealed { 
			return ExecuteStringScript(const_cast<const MCHAR*>(string)); }
#pragma warning( pop )
		/*! \remarks Implemented by the System.\n\n
...
#pragma warning( disable : 4481 )
		//! \deprecated Deprecated method in terms of implementation as of 3ds Max 2013 - re-implement with const MCHAR* method signature
		GUPExport virtual	bool			ExecuteFileScript	( MCHAR *file ) sealed { 
			return ExecuteFileScript(const_cast<const MCHAR*>(file)); }
#pragma warning( pop )
