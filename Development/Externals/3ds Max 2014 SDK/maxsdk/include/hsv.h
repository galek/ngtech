...
#pragma warning( disable : 4481 )
		...
		virtual void SetNewColor (DWORD color, MCHAR *name) MAX_SEALED { SetNewColor(color, const_cast<const MCHAR*>(name)); }
#pragma warning( pop )
...
#pragma warning( disable : 4481 )
		//! \deprecated Deprecated method in terms of implementation as of 3ds Max 2013 - re-implement with const MCHAR* method signature
		virtual void InstallNewCB(DWORD col, HSVCallback *pcb, MCHAR *name) MAX_SEALED { InstallNewCB(col, pcb, const_cast<const MCHAR*>(name)); }
#pragma warning( pop )
...
#pragma warning( disable : 4481 )
		//! \deprecated Deprecated method in terms of implementation as of 3ds Max 2013 - re-implement with const MCHAR* method signature
		virtual void SetNewColor(AColor color, MCHAR * name) MAX_SEALED { SetNewColor(color, const_cast<const MCHAR*>(name)); }
#pragma warning( pop )
...
#pragma warning( disable : 4481 )
		//! \deprecated Deprecated method in terms of implementation as of 3ds Max 2013 - re-implement with const MCHAR* method signature
		virtual void InstallNewCB(AColor col, HSVCallback *pcb, MCHAR *name) MAX_SEALED { InstallNewCB(col, pcb, const_cast<const MCHAR*>(name)); }
#pragma warning( pop )
...
#pragma warning( disable : 4481 )
	//! \deprecated Deprecated method in terms of implementation as of 3ds Max 2013 - re-implement with const MCHAR* method signature
	virtual INT_PTR ModalColorPicker(HWND hwndOwner, DWORD *lpc, IPoint2 *spos, HSVCallback *callBack, MCHAR *name ) MAX_SEALED { 
...
#pragma warning( disable : 4481 )
	//! \deprecated Deprecated method in terms of implementation as of 3ds Max 2013 - re-implement with const MCHAR* method signature
	virtual INT_PTR ModalColorPicker(HWND hwndOwner, AColor *lpc, IPoint2 *spos, HSVCallback *callBack, MCHAR *name) MAX_SEALED { 
		return ModalColorPicker(hwndOwner, lpc, spos, callBack, const_cast<const MCHAR*>(name)); }
#pragma warning( pop )
...
#pragma warning( disable : 4481 )
	//! \deprecated Deprecated method in terms of implementation as of 3ds Max 2013 - re-implement with const MCHAR* method signature
	virtual	ColorPicker *CreateColorPicker(HWND hwndOwner, DWORD initColor, IPoint2* spos, HSVCallback *pcallback, MCHAR *name, BOOL isObjectColor) MAX_SEALED {
...
#pragma warning( disable : 4481 )
	//! \deprecated Deprecated method in terms of implementation as of 3ds Max 2013 - re-implement with const MCHAR* method signature
	virtual	ColorPicker *CreateColorPicker(HWND hwndOwner, AColor initColor, IPoint2* spos, HSVCallback *pcallback, MCHAR *name, BOOL isObjectColor) MAX_SEALED {
			return CreateColorPicker(hwndOwner, initColor, spos, pcallback, const_cast<const MCHAR*>(name)); }
#pragma warning( pop )
