...
#pragma warning( disable : 4481 )
	//! \deprecated Deprecated method in terms of implementation as of 3ds Max 2013 - re-implement with const MCHAR* method signature
	virtual HWND AddTabRollupPage(const Class_ID& id, HINSTANCE hInst, MCHAR *dlgTemplate, DLGPROC dlgProc, MCHAR *title, LPARAM param, DWORD flags, int category) MAX_SEALED { 
...
#pragma warning( disable : 4481 )
	//! \deprecated Deprecated method in terms of implementation as of 3ds Max 2013 - re-implement with const MCHAR* method signature
	virtual HWND AddTabRollupPage(const Class_ID& id, HINSTANCE hInst, DLGTEMPLATE *dlgTemplate, DLGPROC dlgProc, MCHAR *title, LPARAM param, DWORD flags, int category) MAX_SEALED { 
...
#pragma warning( push )
#pragma warning( disable : 4481 )
	// \deprecated Deprecated as of 3ds Max 2013. Implement RenderPresetsMapCategoryToIndex( const MCHAR* category ) 
	virtual int RenderPresetsMapCategoryToIndex( MCHAR* category ) MAX_SEALED { return RenderPresetsMapCategoryToIndex( const_cast<const MCHAR*>(category));}
#pragma warning( pop )
