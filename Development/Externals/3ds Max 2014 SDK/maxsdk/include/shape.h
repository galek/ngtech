...
\sa  Class ShapeObject, Class Spline3D, Class PatchCapInfo, Class ShapeVSel, Class ShapeSSel, Class ShapePSel, Class Material, <a href="ms-its:3dsmaxsdk.chm::/shps_shapes_and_splines.html">Working with Shapes and Splines</a>. */
...
public:
	...
	/*! Display attribute flags. 
		...
		\See <a href="ms-its:listsandfunctions.chm::/idx_R_list_of_beziershape_display_flags.html">List of BezierShape Display Flags</a> */
	DWORD		dispFlags;
