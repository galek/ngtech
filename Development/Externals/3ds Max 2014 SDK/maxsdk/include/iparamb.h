...
/*! \deprecated Deprecated in 3ds Max 2014. Use ParamBlockPLCBEx instead.
...
MAX_DEPRECATED class ParamBlockPLCB : public PostLoadCallback {
	public:
		...
		/*! \brief Constructor.
		\param ParamVersionDesc* v - This is an array of ParamVersionDescs.
		\param int cnt - The number of elements in the array specified above.
		\param ParamVersionDesc* c - This is a pointer to the current version of the ParamVersionDesc.
		\param ReferenceTarget* t - This is a pointer to a reference target. This is usually the
		...
		<a href="ms-its:3dsmaxsdk.chm::/parammap1_root.html">Parameter Maps</a> for an explanation of how this is used. */
		ParamBlockPLCB(
...
/*! Extension of the ParamBlockPLCB class.
	This class should be used instead of ParamBlockPLCB to 
	register for Post Load Callbacks.
	This uses a better mechanism for detecting the validity of the 
	ReferenceTarget* member variable targ. */
class ParamBlockPLCBEx : public ParamBlockPLCB
{
public:
	//! Constructor
	...
	/*! Safe method for getting the targ member variable. 
		...
		ParamBlockPLCB::targ is still valid and hasn't been deleted.
		Therefore, do not access the targ member variable in class ParamBlockPLCB directly
		but rather use this method. 
