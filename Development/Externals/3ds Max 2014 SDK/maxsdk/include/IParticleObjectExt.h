...
#pragma warning( disable : 4481 )
	...
	virtual void SetEveryStepUpdateScriptLine(MCHAR* script) sealed { SetEveryStepUpdateScriptLine(const_cast<const MCHAR*>(script)); }
#pragma warning( pop )
	virtual void SetEveryStepUpdateScriptFile(const MCHAR* file) { ; }
#pragma warning( push )
#pragma warning( disable : 4481 )
	//! \deprecated Deprecated method in terms of implementation as of 3ds Max 2013 - re-implement with const MCHAR* method signature
	virtual void SetEveryStepUpdateScriptFile(MCHAR* file) sealed { SetEveryStepUpdateScriptFile(const_cast<const MCHAR*>(file)); }
#pragma warning( pop )
...
#pragma warning( disable : 4481 )
	//! \deprecated Deprecated method in terms of implementation as of 3ds Max 2013 - re-implement with const MCHAR* method signature
	virtual void SetFinalStepUpdateScriptLine(MCHAR* script) sealed { SetFinalStepUpdateScriptLine(const_cast<const MCHAR*>(script)); }
#pragma warning( pop )
	virtual void SetFinalStepUpdateScriptFile(const MCHAR* file) { ; }
#pragma warning( push )
#pragma warning( disable : 4481 )
	//! \deprecated Deprecated method in terms of implementation as of 3ds Max 2013 - re-implement with const MCHAR* method signature
	virtual void SetFinalStepUpdateScriptFile(MCHAR* file) sealed { SetFinalStepUpdateScriptFile(const_cast<const MCHAR*>(file)); }
#pragma warning( pop )
