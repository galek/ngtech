...
//
// Example for Tekken = 16:
//			First Release Product Update would be:	16.1.<build>.0
//			Second Release Product Update would be:	16.2.<build>.0
//			Etc.
...
#define MAX_PRODUCT_VERSION_MAJOR 16
#endif
...
#define MAX_PRODUCT_YEAR_NUMBER 2014
#endif
...
#define MAX_VERSION _MAX_VERSION(MAX_VERSION_MAJOR, MAX_VERSION_MINOR, VERSION_INT, 0)
