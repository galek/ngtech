...
//@}
		...
		/*! This method checks whether an object is alive in memory, or is
                deleted and is a danling pointer.  The check is not perfectly accurate.
...
#pragma warning( disable : 4481 )
		...
		virtual int SetSelKeyCoordsExpr(ParamDimension *dim, MCHAR *timeExpr, MCHAR *valExpr, DWORD flags) MAX_SEALED {
...
#pragma warning( disable : 4481 )
		...
		virtual void EditTrackParams(
			...
			HWND hParent,
			IObjParam *ip,
			DWORD flags) MAX_SEALED { EditTrackParams(t, dim, const_cast<const MCHAR*>(pname), hParent, ip, flags); }
#pragma warning( pop )
