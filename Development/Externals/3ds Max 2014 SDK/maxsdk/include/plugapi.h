...
#define MAX_RELEASE					MAX_RELEASE_R16 
...
#define MAX_API_NUM					MAX_API_NUM_R160 
...
#define FRONTEND_CONTROL_CLASS_ID	0x001040    //!< \deprecated Front-end-controller functionality has been superceeded by class CUIFrameMgr as of 3ds Max 2013.
...
#define	CTRL_QUAT_CLASS_ID			0x9007  //!< Quaternion controller super-class ID.
...
#define BOOLOBJ_CLASS_ID		0x387BB2BB //!< \deprecated Use NEWBOOL_CLASS_ID as of 3ds Max 2013.
...
#pragma warning( disable : 4481 )
		...
		virtual FPInterface* GetInterface(MCHAR* name) MAX_SEALED { return GetInterface(const_cast<const MCHAR*>(name)); }
#pragma warning( pop )
