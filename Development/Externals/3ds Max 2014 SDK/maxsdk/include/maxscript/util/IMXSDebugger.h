...
#pragma warning( disable : 4481 )
	...
	virtual void OpenDialog(BOOL breakExecution, MCHAR* outString, BOOL setFocus) sealed { 
		OpenDialog(breakExecution, const_cast<const MCHAR*>(outString), setFocus); }
#pragma warning( pop )
...
#pragma warning( disable : 4481 )
	//! \deprecated Deprecated method in terms of implementation as of 3ds Max 2013 - re-implement with const MCHAR* method signature
	virtual void WriteString(MCHAR* str) sealed { WriteString(const_cast<const MCHAR*>(str)); }
#pragma warning( pop )
	virtual void WriteLine(const MCHAR* str) = 0; // output string to output window, appends \n if needed.
#pragma warning( push )
#pragma warning( disable : 4481 )
	//! \deprecated Deprecated method in terms of implementation as of 3ds Max 2013 - re-implement with const MCHAR* method signature
	virtual void WriteLine(MCHAR* str) sealed { WriteLine(const_cast<const MCHAR*>(str)); }
#pragma warning( pop )
...
#pragma warning( disable : 4481 )
	//! \deprecated Deprecated method in terms of implementation as of 3ds Max 2013 - re-implement with const MCHAR* method signature
	virtual void BreakExecution(MCHAR* outString) sealed { BreakExecution(const_cast<const MCHAR*>(outString)); }
#pragma warning( pop )
