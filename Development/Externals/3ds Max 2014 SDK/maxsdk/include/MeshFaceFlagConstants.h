...
#define HAS_TVERTS	(1<<4)	//!< \deprecated Deprecated in 3ds Max 2013. Replaced by mapSupport(). Texture vertices bit: If the bit is 1, texture vertices are present. 
#pragma deprecated("HAS_TVERTS")
