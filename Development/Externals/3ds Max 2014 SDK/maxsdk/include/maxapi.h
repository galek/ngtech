...
#pragma warning( disable : 4481 )
		...
		virtual void PushPrompt( MCHAR *s ) MAX_SEALED { PushPrompt(const_cast<const MCHAR*>(s)); }
#pragma warning( pop )
...
#pragma warning( disable : 4481 )
		//! \deprecated Deprecated method in terms of implementation as of 3ds Max 2013 - re-implement with const MCHAR* method signature
		virtual void ReplacePrompt( MCHAR *s ) MAX_SEALED { ReplacePrompt(const_cast<const MCHAR*>(s)); }
#pragma warning( pop )
...
#pragma warning( disable : 4481 )
		//! \deprecated Deprecated method in terms of implementation as of 3ds Max 2013 - re-implement with const MCHAR* method signature
		virtual void DisplayTempPrompt( MCHAR *s, int msec) MAX_SEALED { DisplayTempPrompt(const_cast<const MCHAR*>(s), msec); }
#pragma warning( pop )
...
#pragma warning( disable : 4481 )
		//! \deprecated Deprecated method in terms of implementation as of 3ds Max 2013 - re-implement with const MCHAR* method signature
		virtual void ChooseDirectory(HWND hWnd, MCHAR *title, MCHAR *dir, MCHAR *desc) MAX_SEALED { 
...
#pragma warning( disable : 4481 )
		//! \deprecated Deprecated method in terms of implementation as of 3ds Max 2013 - re-implement with const MCHAR* method signature
		virtual BOOL ProgressStart(MCHAR *title, BOOL dispBar, LPTHREAD_START_ROUTINE fn, LPVOID arg) MAX_SEALED { 
...
#pragma warning( disable : 4481 )
		//! \deprecated Deprecated method in terms of implementation as of 3ds Max 2013 - re-implement with const MCHAR* method signature
		virtual void ProgressUpdate(int pct, BOOL showPct, MCHAR *title) MAX_SEALED {
...
#pragma warning( disable : 4481 )
		//! \deprecated Deprecated method in terms of implementation as of 3ds Max 2013 - re-implement with const MCHAR* method signature
		virtual void SetCurNamedSelSet(MCHAR *setName) MAX_SEALED { SetCurNamedSelSet(const_cast<const MCHAR*>(setName)); }
#pragma warning( pop )
...
#pragma warning( disable : 4481 )
		//! \deprecated Deprecated method in terms of implementation as of 3ds Max 2013 - re-implement with const MCHAR* method signature
		virtual HWND AddRollupPage(HINSTANCE hInst, MCHAR *dlgTemplate, DLGPROC dlgProc, MCHAR *title, LPARAM param, DWORD flags, int category) MAX_SEALED { 
...
#pragma warning( disable : 4481 )
		//! \deprecated Deprecated method in terms of implementation as of 3ds Max 2013 - re-implement with const MCHAR* method signature
		virtual HWND AddRollupPage(HINSTANCE hInst, DLGTEMPLATE *dlgTemplate, DLGPROC dlgProc, MCHAR *title, LPARAM param, DWORD flags, int category) MAX_SEALED { 
...
#pragma warning( disable : 4481 )
		//! \deprecated Deprecated method in terms of implementation as of 3ds Max 2013 - re-implement with const MCHAR* method signature
		virtual HWND ReplaceRollupPage(HWND hOldRollup, HINSTANCE hInst, MCHAR *dlgTemplate, DLGPROC dlgProc, MCHAR *title, LPARAM param, DWORD flags, int category) MAX_SEALED { 
...
#pragma warning( disable : 4481 )
		//! \deprecated Deprecated method in terms of implementation as of 3ds Max 2013 - re-implement with const MCHAR* method signature
		virtual HWND ReplaceRollupPage(HWND hOldRollup, HINSTANCE hInst, DLGTEMPLATE *dlgTemplate, DLGPROC dlgProc, MCHAR *title, LPARAM param, DWORD flags, int category) MAX_SEALED { 
...
#pragma warning( disable : 4481 )
		//! \deprecated Deprecated method in terms of implementation as of 3ds Max 2013 - re-implement with const MCHAR* method signature
		virtual void FileSaveSelected(MCHAR *fname) MAX_SEALED { FileSaveSelected(const_cast<const MCHAR*>(fname)); }
#pragma warning( pop )
...
#pragma warning( disable : 4481 )
		//! \deprecated Deprecated method in terms of implementation as of 3ds Max 2013 - re-implement with const MCHAR* method signature
		virtual void FileSaveNodes(INodeTab* nodes, MCHAR *fname) MAX_SEALED { FileSaveNodes(nodes,const_cast<const MCHAR*>(fname)); }
#pragma warning( pop )
...
#pragma warning( disable : 4481 )
		//! \deprecated Deprecated method in terms of implementation as of 3ds Max 2013 - re-implement with const MCHAR* method signature
		virtual void RAMPlayer(HWND hWndParent, MCHAR* szChanA, MCHAR* szChanB) MAX_SEALED { RAMPlayer(hWndParent, const_cast<const MCHAR*>(szChanA), const_cast<const MCHAR*>(szChanB)); }
#pragma warning( pop )
...
#pragma warning( disable : 4481 )
	//! \deprecated Deprecated method in terms of implementation as of 3ds Max 2013 - re-implement with const MCHAR* method signature
	virtual int MAXScriptHelp(MCHAR* keyword) MAX_SEALED { return MAXScriptHelp(const_cast<const MCHAR*>(keyword)); }
#pragma warning( pop )
...
#pragma warning( disable : 4481 )
	//! \deprecated Deprecated method in terms of implementation as of 3ds Max 2013 - re-implement with const MCHAR* method signature
	virtual BOOL SetDir(int which, MCHAR *dir) MAX_SEALED { return SetDir(which, const_cast<const MCHAR*>(dir)); }
#pragma warning( pop )
...
#pragma warning( disable : 4481 )
	//! \deprecated Deprecated method in terms of implementation as of 3ds Max 2013 - re-implement with const MCHAR* method signature
	virtual BOOL AddAssetDir(MCHAR *dir, MaxSDK::AssetManagement::AssetType assetType, int update) MAX_SEALED { 
...
#pragma warning( disable : 4481 )
	//! \deprecated Deprecated method in terms of implementation as of 3ds Max 2013 - re-implement with const MCHAR* method signature
	virtual BOOL OpenSchematicViewWindow(MCHAR* sv_name) MAX_SEALED { return OpenSchematicViewWindow(const_cast<const MCHAR*>(sv_name)); }
#pragma warning( pop )
	virtual BOOL SchematicViewZoomSelected(const MCHAR* sv_name) = 0;
#pragma warning( push )
#pragma warning( disable : 4481 )
	//! \deprecated Deprecated method in terms of implementation as of 3ds Max 2013 - re-implement with const MCHAR* method signature
	virtual BOOL SchematicViewZoomSelected(MCHAR* sv_name) MAX_SEALED { return SchematicViewZoomSelected(const_cast<const MCHAR*>(sv_name)); }
#pragma warning( pop )
	virtual BOOL CloseSchematicView(const MCHAR* sv_name) = 0;
#pragma warning( push )
#pragma warning( disable : 4481 )
	//! \deprecated Deprecated method in terms of implementation as of 3ds Max 2013 - re-implement with const MCHAR* method signature
	virtual BOOL CloseSchematicView(MCHAR* sv_name) MAX_SEALED { return CloseSchematicView(const_cast<const MCHAR*>(sv_name)); }
#pragma warning( pop )
...
#pragma warning( disable : 4481 )
	//! \deprecated Deprecated method in terms of implementation as of 3ds Max 2013 - re-implement with const MCHAR* method signature
	virtual void LoadCUIConfig(MCHAR* fileName) MAX_SEALED { LoadCUIConfig(const_cast<const MCHAR*>(fileName)); }
#pragma warning( pop )
...
#pragma warning( disable : 4481 )
	//! \deprecated Deprecated method in terms of implementation as of 3ds Max 2013 - re-implement with const MCHAR* method signature
	virtual ClassDesc *DoPickClassDlg(HWND hParent, MCHAR *title, SClass_ID super, PickClassCallback *pPickClassCB) MAX_SEALED { 
...
#pragma warning( disable : 4481 )
	//! \deprecated Deprecated method in terms of implementation as of 3ds Max 2013 - re-implement with const MCHAR* method signature
	virtual int DoMultiplePickClassDlg(HWND hParent, MCHAR *title, SClass_ID super, PickClassCallback *pPickClassCB, Tab<ClassDesc *> *classDescTab) MAX_SEALED { 
