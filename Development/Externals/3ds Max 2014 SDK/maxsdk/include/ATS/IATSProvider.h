...
#pragma warning( disable : 4481 )
	...
	virtual ATSResult		OpenProject( MCHAR *szPath, const MCHAR *szComment, ATSOption atsOptions ) sealed { 
		return OpenProject(const_cast<const MCHAR*>(szPath), szComment, atsOptions); }
#pragma warning( pop )
	//! \brief Close project
