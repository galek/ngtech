...
public:
	...
	\param IMenu* pMenu - Points to the menu to register or add
	\param DWORD flags = 0 - Not used.
	...
	\param IMenu* pMenu - Points to the menu to unregister.
	...
	\param MCHAR* pTitle - The name of the menu to find.
	...
	\param MCHAR* pTitle - The name of the menu to return.
	...
	\param MenuContextId contextId - The menu context ID.
	\param MCHAR* pName - The name of the menu bar.
	...
	\param MenuContextId contextId - The menu context ID.
	\param MCHAR* pName - The name of the quad menu.
