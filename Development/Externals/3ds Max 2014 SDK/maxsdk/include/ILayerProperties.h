...
#pragma warning( disable : 4481 )
	...
	virtual BOOL    setName	(MCHAR *name) MAX_SEALED { return setName(const_cast<const MCHAR*>(name)); }
#pragma warning( pop )
...
#pragma warning( disable : 4481 )
	//! \deprecated Deprecated method in terms of implementation as of 3ds Max 2013 - re-implement with const MCHAR* method signature
	virtual	BOOL                deleteLayer (MCHAR* name) MAX_SEALED { return deleteLayer(const_cast<const MCHAR*>(name)); }
#pragma warning( pop )
...
#pragma warning( disable : 4481 )
	//! \deprecated Deprecated method in terms of implementation as of 3ds Max 2013 - re-implement with const MCHAR* method signature
	virtual	ILayerProperties*	getLayer	(MCHAR *name) MAX_SEALED { return getLayer(const_cast<const MCHAR*>(name)); }
#pragma warning( pop )
	virtual	ILayerProperties*	newLayer	(const MCHAR *)		=	0;
#pragma warning( push )
#pragma warning( disable : 4481 )
	//! \deprecated Deprecated method in terms of implementation as of 3ds Max 2013 - re-implement with const MCHAR* method signature
	virtual	ILayerProperties*	newLayer	(MCHAR *name) MAX_SEALED { return newLayer(const_cast<const MCHAR*>(name)); }
#pragma warning( pop )
