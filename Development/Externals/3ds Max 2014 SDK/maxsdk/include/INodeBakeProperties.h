...
#pragma warning( disable : 4481 )
	...
	virtual BOOL RemoveBakeElementByName( MCHAR * name ) sealed { return RemoveBakeElementByName(const_cast<const MCHAR*>(name)); }
#pragma warning( pop )
...
#pragma warning( disable : 4481 )
	//! \deprecated Deprecated method in terms of implementation as of 3ds Max 2013 - re-implement with const MCHAR* method signature
	virtual void    SetProjModTarg( MCHAR* s ) sealed { return SetProjModTarg(const_cast<const MCHAR*>(s)); }
#pragma warning( pop )
