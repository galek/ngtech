	...
	public:
			...
			*/
			...
			IOResult Gradient::Load(ILoad *iload)
			{
				...
				iload->RegisterPostLoadCallback(new ParamBlockPLCBEx(versions,NUM_OLDVERSIONS,&curVersion,this,1));
				return IO_OK;
			}
			\endcode */
...
#pragma warning( disable : 4481 )
			//! \deprecated Deprecated method in terms of implementation as of 3ds Max 2013 - re-implement with const MCHAR* method signature
			virtual  void AddMapName(MCHAR *name) MAX_SEALED { AddMapName(const_cast<const MCHAR*>(name)); }
#pragma warning( pop )
	 };
