...
#pragma warning( disable : 4481 )
    ...
    virtual void AppendText(MCHAR* pText, Point3& position, DWORD flags, Point3& unselColor, Point3& selColor) sealed { 
		AppendText(const_cast<const MCHAR*>(pText), position, flags, unselColor, selColor);}
#pragma warning( pop )
