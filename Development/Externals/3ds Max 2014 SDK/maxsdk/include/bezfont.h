...
public:
	...
	/*!	Build the given bezier from of the character in the given shape, and send back
		its relative width. 
		\sa class BezFontEX2
		\param BEZFONTHANDLE handle - The handle
		\param UINT index - The index
		\param float height - The height
		\param BezierShape& shape - The bezier shape
		\param float& width - The out parameter containing the width of the character
		\param int fontShapeVersion - The version. Default value of 1
		\param bool ggo_native -if true, build character shape of glyph outline data on TrueType Glyph Index, otherwise on a character code
