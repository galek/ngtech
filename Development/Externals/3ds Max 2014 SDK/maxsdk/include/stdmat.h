...
#pragma warning( disable : 4481 )
	...
	virtual void AddMtl(ReferenceTarget *rt, int mtlid, MCHAR *name) sealed { 
...
#pragma warning( disable : 4481 )
	//! \deprecated Deprecated method in terms of implementation as of 3ds Max 2013 - re-implement with const MCHAR* method signature
	virtual void ReadSXPData(MCHAR *name, void *sxpdata) sealed { 
		return ReadSXPData(const_cast<const MCHAR*>(name), sxpdata); }
#pragma warning( pop )
	};
