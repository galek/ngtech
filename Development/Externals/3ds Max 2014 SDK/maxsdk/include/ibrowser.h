...
#pragma warning( disable : 4481 )
	...
	virtual IBrowser* NewBrowser(MCHAR* rootURL, BOOL showDirectory, BOOL showContent, BOOL showToolbar, BOOL showMenu, HWND parentWindow) sealed { 
		return NewBrowser(const_cast<const MCHAR*>(rootURL), showDirectory, showContent, showToolbar, showMenu, parentWindow); }
#pragma warning( pop )
	// iterate browsers
...
#pragma warning( disable : 4481 )
	//! \deprecated Deprecated method in terms of implementation as of 3ds Max 2013 - re-implement with const MCHAR* method signature
	virtual BOOL	SetRootURL(MCHAR* rootURL) sealed { return SetRootURL(const_cast<const MCHAR*>(rootURL));}
#pragma warning( pop )
	virtual BOOL	BrowseTo(const MCHAR* browseURL)=0;
#pragma warning( push )
#pragma warning( disable : 4481 )
	//! \deprecated Deprecated method in terms of implementation as of 3ds Max 2013 - re-implement with const MCHAR* method signature
	virtual BOOL	BrowseTo(MCHAR* browseURL) sealed { return BrowseTo(const_cast<const MCHAR*>(browseURL));}
#pragma warning( pop )
